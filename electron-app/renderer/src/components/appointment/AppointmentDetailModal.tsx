...
export function AppointmentDetailModal({
  ...
  const handleCompleteService = async (serviceId: string) => {
    try {
      ...
      notifications.show({
        title: "Erro",
        message: error instanceof Error ? error.message : "Erro ao concluir serviço",
        color: "red",
      });
    }
  };
  ...
  const handleCancelService = async (serviceId: string) => {
    try {
      ...
      notifications.show({
        title: "Erro",
        message: error instanceof Error ? error.message : "Erro ao cancelar serviço",
        color: "red",
      });
    }
  };
                ...
                try {
                  ...
                  if (!luxonDate.isValid) {
                    ...
                    if (parsedDate.isValid) {
                      return parsedDate.setLocale("pt-BR").toFormat("cccc, d 'de' MMMM 'de' yyyy");
                    }
                    return "Data inválida";
                  }
                  ...
                  console.error("Erro ao formatar data:", error, appointment.date);
                  return "Data inválida";
                }
              })()}
            </Text>
